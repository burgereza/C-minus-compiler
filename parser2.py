...
grammar = {
    ...
    'DeclarationInitial' : [['TypeSpecifier', '#push' , 'ID', '#push']],
    'DeclarationPrime' : [['#function_start' ,'FunDeclarationPrime'], ['VarDeclarationPrime']],
    'VarDeclarationPrime' : [['#define_variable',';'],['[', 'NUM' , '#push', '#define_array', ']', ';']], 
    'FunDeclarationPrime' : [ ['(', 'Params', ')', '#define_function', 'CompoundStmt', '#end_of_scope', '#end_of_function']],
    'TypeSpecifier': [['int'], ['void']],
    'Params': [['int', '#push', 'ID', '#push', 'ParamPrime', 'ParamList'], ['void']],
    ...
    'ExpressionStmt' : [['Expression', '#pop_number',';'], ['break', '#break_command',';'], [';']],
    'SelectionStmt' : [['if', '(', 'Expression', '#start_if', ')', 'Statement', 'else', '#start_else', 'Statement', '#end_if']],
    'IterationStmt' :[[ 'while', '(', '#start_while', 'Expression', ')', '#while_condition', 'Statement', '#end_while']], 
    'ReturnStmt' :[['return', 'ReturnStmtPrime']],
    'ReturnStmtPrime':[['#function_return' ,';'],['Expression', '#function_return_with_value', ';']],
    'Expression': [['SimpleExpressionZegond'], ['ID', '#push_id', 'B']],
    'B':[[ '=', 'Expression', '#assign'], ['[', 'Expression', ']', '#find_array_index_address', 'H'], ['SimpleExpressionPrime']],
    'H':[[ '=', 'Expression', '#assign'], ['G', 'D', 'C']],
    'SimpleExpressionZegond': [['AdditiveExpressionZegond', 'C']],
    'SimpleExpressionPrime' : [['AdditiveExpressionPrime', 'C']],
    'C': [['Relop', 'AdditiveExpression', '#add_or_sub_or_compare'],['EPSILON']], 
    'Relop': [['<', '#LT'],['==', '#EQ']], 
    'AdditiveExpression': [['Term', 'D']],
    'AdditiveExpressionPrime': [['TermPrime', 'D']],
    'AdditiveExpressionZegond': [['TermZegond', 'D']],
    'D': [['Addop', 'Term', '#add_or_sub_or_compare', 'D'],['EPSILON']], 
    'Addop':[['+', '#add_values'],['-', '#sub_values']], 
    'Term': [['SignedFactor', 'G']],
    'TermPrime': [['SignedFactorPrime', 'G']],
    'TermZegond':[['SignedFactorZegond', 'G']],
    'G':[['*', 'SignedFactor', '#mult_values','G'],['EPSILON']],
    'SignedFactor': [['+' , 'Factor'] , ['-' , 'Factor', '#change_sign'], ['Factor']],
    'SignedFactorPrime' : [['FactorPrime']],
    'SignedFactorZegond': [['+', 'Factor'] , ['-', 'Factor', '#change_sign'] , ['FactorZegond']],
    'Factor':[['(', 'Expression', ')'], ['ID', '#push_id','VarCallPrime'], ['NUM', '#push_number']],
    'VarCallPrime':[['#function_call_start', '(', 'Args', ')', '#function_call'], ['VarPrime']],
